...
from src.utils import input_to_internal, internal_to_json
...
class TestUtils(unittest.TestCase):
    ...
    def test_input_to_internal(self):
        ...
        self.assertEqual(len(financial_data_dict), 3)
        self.assertIsInstance(financial_data_dict[2023], FinancialData)
        self.assertEqual(financial_data_dict[2023].savings, 20000)
        self.assertEqual(financial_data_dict[2023].withdrawals, 10000)
    ...
    def test_internal_to_json(self):
        ...
        self.assertIn('"year": 2023', json_output)
