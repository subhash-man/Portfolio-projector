...
class TestMain(unittest.TestCase):
    ...
    def test_main(self, mock_json_load, mock_open):
        mock_json_load.side_effect = [
            ...
            json.loads('[{"scenario_id": 1, "years": [{"year": 2023, "equity_return": 0.1, "fixed_income_return": 0.05}, {"year": 2024, "equity_return": 0.1, "fixed_income_return": 0.05}, {"year": 2025, "equity_return": 0.1, "fixed_income_return": 0.05}]}]')
        ]
